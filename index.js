...
var startActivityForResult = (
    key, uri, action, byTran, byTID, byInstall, 
    byAmt, byTaxAmt, bySfeeAmt, byFreeAmt, 
    byOrgDate, byOrgAuth, byIdno) => {
    
    return RNStartActivityForResult.startActivityForResult(
        key, uri, action, byTran, byTID, byInstall, byAmt, byTaxAmt, 
        bySfeeAmt, byFreeAmt, byOrgDate, byOrgAuth, byIdno
    );
};
